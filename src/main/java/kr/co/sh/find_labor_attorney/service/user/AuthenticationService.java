package kr.co.sh.find_labor_attorney.service.user;

import java.util.HashSet;
import java.util.Set;
import kr.co.sh.find_labor_attorney.config.JwtService;
import kr.co.sh.find_labor_attorney.controller.user.dto.AuthenticationResponse;
import kr.co.sh.find_labor_attorney.entity.roles.Role;
import kr.co.sh.find_labor_attorney.entity.roles.Role.RoleType;
import kr.co.sh.find_labor_attorney.entity.users.User;
import kr.co.sh.find_labor_attorney.entity.users.UserRole;
import kr.co.sh.find_labor_attorney.entity.users.repository.UserRepository;
import kr.co.sh.find_labor_attorney.entity.users.repository.UserRoleRepository;
